...
1. **Inaugural project.** Our first encounter with python. The **results** can be seen from running [inaugural.ipynb](inaugural.ipynb) and the associated python file [inaugural.py](inaugural.py)  
